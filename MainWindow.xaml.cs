...
namespace SahanOhjausGUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private (double ph1Vasen, double ph1Oikea, double ph2Vasen, double ph2Oikea) LaskePhArvot()
        {
            bool jakosahaOn = OnJakosahaKaytossa();
      ...
      double halkaisija, double scale)
        {
            ...
            // Pelkka — täytetty tummemmalla + keltaiset reunaviivat
            canvas.Children.Add(new Rectangle
            {
                Width = pelkkaW,
                Height = pelkkaH,
            ...
            // Peitetään tukin vasen kaari (pelkan vasemmalle puolelle jäävä alue)
            canvas.Children.Add(new Rectangle
            {
            ...
            // Peitetään tukin oikea kaari (pelkan oikealle puolelle jäävä alue)
            canvas.Children.Add(new Rectangle
            {
            ...
            // PH1 sahaviivat — punainen
            double ph1VX = cx - ph1V * scale;
            double ph1OX = cx + ph1O * scale;
            var sahaBrush = new SolidColorBrush(Color.FromRgb(255, 80, 80));
            canvas.Children.Add(new Line
            { X1 = ph1VX, Y1 = pelkkaY - 10, X2 = ph1VX, Y2 = pelkkaY + pelkkaH + 10, Stroke = sahaBrush, StrokeThickness = 2.5 });
            canvas.Children.Add(new Line
            { X1 = ph1OX, Y1 = pelkkaY - 10, X2 = ph1OX, Y2 = pelkkaY + pelkkaH + 10, Stroke = sahaBrush, StrokeThickness = 2.5 });

            // PH1 mitta-nuoli alapuolella
            ...
            {
                Text = $"Ph1 leveys  {ph1Leveys:F1} mm",
                FontSize = 11,
                Foreground = ph1Br,
                TextAlignment = TextAlignment.Center,
                Width = Math.Max(80, pelkkaW + 20)
            };
        ...
        private static void PiirraPh2Canvas(Canvas canvas,
            double ph2V, double ph2O, double ph1Leveys, double halkaisija, double scale)
        {
            canvas.Children.Clear();
            double W = canvas.ActualWidth > 20 ? canvas.ActualWidth : 400;
            double H = canvas.ActualHeight > 20 ? canvas.ActualHeight : 400;
            ...
            {
                Text = $"Ph2 leveys  {ph2Leveys:F1} mm",
                FontSize = 11,
                Foreground = ph2Br,
                TextAlignment = TextAlignment.Center,
